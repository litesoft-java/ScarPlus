...
{
    public static final Parameter NAME = def( "name", String.class, "The name of the project. Used to name the JAR.", //
                                              "Default:\n" + //
    ...
    public static final Parameter VERSION = def( "version", String.class, "The version of the project. If available, used to name the JAR." );
    ...
    public static final Parameter DEPENDENCIES = def( "dependencies", null, "Relative or absolute paths to dependency project directories or YAML files." );
    ...
    public static final Parameter MAIN = def( "main", String.class, "Name of the main class." );
}
